...
#' @param filter Desired adjusted p-value threshold for filtering output
#'   pathways. Defaults to 0.05.
#' @param background Optional background genes used when testing
#'
#' @return A tibble of significantly enriched Reactome pathways
#'
#' @export
#'
#' @import dplyr
